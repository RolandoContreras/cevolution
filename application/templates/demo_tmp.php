...
<html lang="en">
    ...
    <body class="layout-6" style="background-image: url('http://html.codedthemes.com/datta-able/bootstrap/assets/images/bg-images/bg1.jpg'); background-size: cover;">
                    ...
                    <ul class="nav pcoded-inner-navbar">
                        ...
                        <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item pcoded-hasmenu active pcoded-trigger">
                            ...
                            <ul class="pcoded-submenu">
                                ...
                                <li class="active"><a href="dashboard-crypto.html" class="">Crypto<span class="pcoded-badge label label-danger">NEW</span></a></li>
        ...
        <script src="../assets/js/menu-setting-advance.min.js"></script>
        ...
        <script src="../assets/js/pages/dashboard-crypto.js"></script>
    </body>
</html>
