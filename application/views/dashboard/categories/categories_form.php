            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="page-header-title">
                  <h5 class="m-b-10">Formulario de Categoria</h5>
                </div>
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#!">Diseño</a></li>
                </ul>
              </div>
            </div>
          </div>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                if(isset($obj_category)){ ?>
                                  <div class="form-group">
                                        <label>ID</label>
                                        <input class="form-control" type="text" value="<?php echo isset($obj_category->category_id)?$obj_category->category_id:"";?>" class="input-xlarge-fluid" placeholder="ID" disabled="">
                                        <input type="hidden" id="category_id" name="category_id" value="<?php echo isset($obj_category->category_id)?$obj_category->category_id:"";?>">
                                  </div>
                            <?php } ?>
                            </div>
