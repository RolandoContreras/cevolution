            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="page-header-title">
                  <h5 class="m-b-10">Formulario de Diseños</h5>
                </div>
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo site_url().'dashboard/diseno';?>">Listado de Diseños</a></li>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form enctype="multipart/form-data" method="post" action="<?php echo site_url()."dashboard/disenos/validate";?>">
                        <div class="form-row">
