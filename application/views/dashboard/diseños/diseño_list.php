            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="page-header-title">
                  <h5 class="m-b-10">Mantenimientos de Diseños</h5>
                </div>
                <ul class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo site_url().'dashboard/';?>">Panel</a></li>
                  <li class="breadcrumb-item"><a>Diseños</a></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    <h5>Listado de Diseños</h5>
                    <button class="btn btn-secondary" type="button" onclick="new_diseño();"><span><span class="pcoded-micon"><i data-feather="plus"></i></span> Nuevo</span></button>
                  </div>
                          ...
                          <div class="col-sm-12">
                            <table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" style="width: 100%;" role="grid" aria-describedby="zero-configuration_info">
                              ...
                              <tbody>
                                ...
                                <tr>
                                <th><?php echo $value->diseño_id;?></th>
                                <td><?php echo formato_fecha($value->date);?></td>
                                <td><?php echo $value->name;?></td>
                                <td><img width="50" src="<?php echo site_url().'static/backoffice/img/diseños/'.$value->img;?>"></td>
                                <td>
                                ...
                                <td>
                                    <div class="operation">
                                            <div class="btn-group">
                                               <button class="btn btn-secondary" type="button" onclick="edit_diseño('<?php echo $value->diseño_id;?>');"><span><span class="pcoded-micon"><i data-feather="edit"></i></span> Editar</span></button>
                                               <button class="btn btn-secondary" type="button" onclick="delete_diseño('<?php echo $value->diseño_id;?>');"><span><span class="pcoded-micon"><i data-feather="trash-2"></i></span> Eliminar</span></button>
                                            </div>
                                    </div>
                                </td>
                            </tr>
