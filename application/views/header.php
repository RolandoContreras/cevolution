                        ...
                        <div class="rd-navbar-top-panel__left">
                            <ul class="rd-navbar-items-list">
                                ...
                                <li>
                                    <div class="unit flex-row align-items-center unit-spacing-xs">
                                        <div class="unit__left">
                                            <span class="icon-primary icon-sm lnr lnr lnr-phone-handset"></span>
                                        </div>
                                        <div class="unit__body">
                                            <ul class="list-semicolon">
                                                <li><a href="tel:#">(51) 929 498 649 </a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
            ...
            <div class="rd-navbar-inner rd-navbar-search-wrap">
                ...
                <div class="rd-navbar-panel rd-navbar-search-lg_collapsable">
                    ...
                    <div class="rd-navbar-brand">
                        <a class="brand-name" href="<?php echo site_url(); ?>">
                            <img src="<?php echo site_url() . 'static/page_front/images/logo/logo.png'; ?>" alt="logo" width="250" srcset="<?php echo site_url() . 'static/page_front/images/logo/logo.png'; ?> 2x"/>
                        </a>
                    </div>
                </div>
                <!-- RD Navbar Nav-->
                <div class="rd-navbar-nav-wrap rd-navbar-search_not-collapsable">
                    ...
                    <div class="rd-navbar__element rd-navbar-search_collapsable">
                        <a href="https://api.whatsapp.com/send?phone=51929498649" title="Whatssapp Evolucion Web" target="_blank" rel="noopener">
                    ...
                    <div class="rd-navbar-search_collapsable">
                        <ul class="rd-navbar-nav">
                            ...
                            <li>
                                <a class="button button-primary button-shadow margin-top-11" href="<?php echo site_url() . 'demo'; ?>">PROBAR DEMO</a>
                            </li>
                        </ul>
                    </div>
                </div>
